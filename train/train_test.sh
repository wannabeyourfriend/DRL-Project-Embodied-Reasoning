...
MY_CUSTOM_PLUGINS="/cluster/home1/wzx/EgoReasoner/train/test/test_accuracy_reward.py"
CONSOLIDATED_DATASET_PATH="/cluster/home1/wzx/EgoReasoner/train/test/test_dataset.jsonl" # 小规模pipeline验证实验
...
/cluster/home2/yueyang/miniconda3/envs/swift_env/lib/python3.10/site-packages/swift/cli/rlhf.py \
    ...
    --reward_funcs test_accuracy_reward format \
